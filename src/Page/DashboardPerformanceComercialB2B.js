...
import "../CSS/DashboardPerformanceComercialB2B.css";
...
function DashboardPerformanceComercialB2B() {
  const [activeSection, setActiveSection] = useState("ranking-semanal");
  const [activeBusiness, setActiveBusiness] = useState("B2B");
  ...
  try {
    const url = `http://38.224.145.3:3011/top-vendedores-mensais`;
...
useEffect(() => {
  ...
  const fetchTopVendedoresSemana = async () => {
    try {
      const url = `http://38.224.145.3:3011/top-vendedores-semanais`;
      const response = await fetch(url);
      const data = await response.json();
            ...
            <section className="rankings">
              <div className="ranking-table">
                ...
                <table>
                  ...
                  <tbody>
                    {topVendedoresSemana
                      .filter((item) => item.tipo_pessoa === "pj")
                      .slice(0, 5)
                      .map((item, idx) => (
            ...
            <section className="highlights">
              ...
              <div className="highlight-group">
                ...
                <div className="highlight-row">
                  ...
                  {topVendedores.filter((v) => v.tipo_pessoa === "pj")[0] &&
                    (() => {
...
export default DashboardPerformanceComercialB2B;
